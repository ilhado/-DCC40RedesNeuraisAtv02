% DCC40 - Atividade 02
% Reconhecimento de padrões via RNA - Questão 2 com função de ativação tangente hiperbólica
...
D = baseOriginal (:,7)';
arquivoSaida = fopen('C:\Users\oficial\Documents\DCCMAPI\Atv02\saidaT22.mat','w');
arquivoSaidaTreinos = fopen('C:\Users\oficial\Documents\DCCMAPI\Atv02\saidaTreinos22.mat','w');
