% DCC40 - Atividade 02
% Reconhecimento de padrões via RNA - Questão 2 com função de ativação sigmoide
...
D = baseOriginal (:,7)';
arquivoSaida = fopen('C:\Users\oficial\Documents\DCCMAPI\Atv02\saidaT21.mat','w');
arquivoSaidaTreinos = fopen('C:\Users\oficial\Documents\DCCMAPI\Atv02\saidaTreinos21.mat','w');
